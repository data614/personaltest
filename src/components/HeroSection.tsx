      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Get hyper-personalized career, education, and skill development roadmaps 
            tailored to your unique personality, skills, and life goals.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-16 border-t border-border/50">
            <div className="text-center">
              ...
              <div className="text-muted-foreground">Career Paths Created</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-muted-foreground">AI Guidance Available</div>
            </div>
          </div>
        </div>
      </div>
